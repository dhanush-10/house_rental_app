...
class New_Owner extends StatefulWidget {
  const New_Owner({super.key});

  @override
  State<New_Owner> createState() => _New_UserState();
}

class _New_UserState extends State<New_Owner> {
  //declare variables
  String name = " ";
  String place = " ";
  String email = " ";
    ...
    if (password != "" &&
      ...
      try {
        ...
        if (e.code == 'weak-password') {
          // ignore: use_build_context_synchronously
          ScaffoldMessenger.of(context)
              .showSnackBar(const SnackBar(content: Text('password is to weak')));
