...
import 'package:house_rental_app/User/New_user.dart';
import 'package:house_rental_app/components/squaretile.dart';
import 'package:house_rental_app/services/auth.dart';
import 'package:house_rental_app/widgets/Home.dart';
import 'package:house_rental_app/components/forgotpass.dart';
...
class LoginUser extends StatefulWidget {
  ...
  @override
  State<LoginUser> createState() => _LoginWidgetState();
}

class _LoginWidgetState extends State<LoginUser> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  'Welcome you to  User Sign-in Page',
                  style: TextStyle(
                      fontSize: 24,
                ...
                Row(
                  ...
                  children: <Widget>[
                    GestureDetector(
                        onTap: () {
                          AuthMethods().signinWithGoogle(BuildContext, context);
                        },
                        child:
